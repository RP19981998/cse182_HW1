...
def affine_relu_forward(x, w, b):
    ...
    """
    a, fc_cache = affine_forward(x, w, b)#a for FC output, x/w/c for fc_cache
    out, relu_cache = relu_forward(a)#out for max(0,a), relu_cache for FC output a
    cache = (fc_cache, relu_cache)# x/w/b, FC output a 
    return out, cache
